...
PRIVATE_MODULES = [
    {
        ...
        "summary": {
            "ca": "El punt central per substituir els PDFs i consultar tarifes reals des de la web privada.",
            "es": "El punto central para sustituir los PDFs y consultar tarifas reales desde la web privada.",
        },
    ...
    },
    {
        ...
        "summary": {
            "ca": "Mesures reals del catàleg, laminat Protter, marge de bastidor i opcions de manipulació.",
            "es": "Medidas reales del catálogo, laminado Protter, margen de bastidor y opciones de manipulación.",
        },
    ...
    },
    {
        ...
        "summary": {
            "ca": "Paper Lustre o Silk, opcions de laminat i foam, i marc enviat directament a la calculadora específica.",
            "es": "Papel Lustre o Silk, opciones de laminado y foam, y marco enviado directamente a la calculadora específica.",
        },
    ...
    },
    {
        ...
        "summary": {
            "ca": "Entrada integrada a la calculadora actual de marcs, sense tocar ni perdre la informació que ja teniu.",
            "es": "Entrada integrada a la calculadora actual de marcos, sin tocar ni perder la información que ya tenéis.",
        },
    ...
    },
    {
        ...
        "summary": {
            "ca": "Format, coberta, pàgines i extres dins del mateix entorn privat.",
            "es": "Formato, cubierta, páginas y extras dentro del mismo entorno privado.",
        },
        "href": None,
    },
    {
        ...
        "summary": {
            "ca": "Catàleg compartit d'acabats i extres per no duplicar lògica entre productes.",
            "es": "Catálogo compartido de acabados y extras para no duplicar lógica entre productos.",
        },
        "href": None,
    },
    {
        ...
        "summary": {
            "ca": "Pressupost per al client final, ordre de laboratori i recepció del fitxer dins del mateix flux.",
            "es": "Presupuesto para el cliente final, orden de laboratorio y recepción del archivo dentro del mismo flujo.",
        },
